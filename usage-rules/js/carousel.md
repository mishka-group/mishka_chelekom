...
- **Autoplay**: Automatic slide advancement with configurable interval; pauses on hover
...
<.carousel id="my-carousel">
  <:slide image="/images/slide1.jpg"><h2>Slide 1</h2></:slide>
  <:slide image="/images/slide2.jpg"><h2>Slide 2</h2></:slide>
</.carousel>

<!-- With autoplay -->
<.carousel id="auto-carousel" autoplay={true} autoplay_interval={3000}>
...
<.carousel id="hero-slider" indicator={true}>
  <:slide image="/images/hero1.jpg"><h1>Welcome</h1></:slide>
  <:slide image="/images/hero2.jpg"><h1>Features</h1></:slide>
</.carousel>
