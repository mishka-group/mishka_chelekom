defmodule DevelopmentWeb.Components.Chat do
  @moduledoc """
  `DevelopmentWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
