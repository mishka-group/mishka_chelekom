defmodule DevelopmentWeb.Components.Accordion do
  @moduledoc """
  The `DevelopmentWeb.Components.Accordion` module provides a flexible and customizable accordion
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/accordion
  ...
  @doc type: :component
  attr :id, :string, doc: "A unique identifier for the accordion"
  ...
  slot :item, required: false, doc: "Accordion items as slots" do
    ...
    attr :open, :boolean,
      doc: "Whether this item should be initially open especially when you do not set id manually"
  end
