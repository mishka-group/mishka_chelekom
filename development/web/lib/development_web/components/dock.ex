defmodule DevelopmentWeb.Components.Dock do
  @moduledoc """
  The `DevelopmentWeb.Components.Dock` module provides a flexible dock (bottom navigation) component for
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/dock
  ...
  ```elixir
  <.dock id="main-dock" color="primary" variant="shadow" position="fixed_bottom">
  ...
  ```elixir
  <.dock id="mini" position="fixed_bottom_center" rounded="full" size="large" show_labels={false}>
  ...
  defp item_color_class(variant, _color, _active)
       when variant in ["base", "default", "shadow", "gradient"], do: nil
