defmodule DevelopmentWeb.Components.FileField do
  @moduledoc """
  The `DevelopmentWeb.Components.FileField` module provides a versatile and customizable component
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms/file-field
  ...
  import DevelopmentWeb.Components.Progress, only: [progress: 1]
  ...
  attr :id, :string,
    default: nil,
    doc:
      "A unique identifier is used to manage state and interaction; with `live` or `dropzone` it lands on the wrapper, because the file input is identified by the upload ref"
  ...
  attr :upload, :any,
    doc: "A single `Phoenix.LiveView.UploadConfig`, used when `live` is set without a dropzone"
