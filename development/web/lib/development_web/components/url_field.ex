defmodule DevelopmentWeb.Components.UrlField do
  @moduledoc """
  DevelopmentWeb.Components.UrlField, A component for rendering a URL input field in a Phoenix application.
