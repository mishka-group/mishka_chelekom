defmodule DevelopmentWeb.Components.Image do
  @moduledoc """
  The `DevelopmentWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
