defmodule DevelopmentWeb.Components.Drawer do
  @moduledoc """
  The `DevelopmentWeb.Components.Drawer` module provides a flexible and customizable drawer component
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/drawer
  ...
  def drawer(assigns) do
    ...
    <div
      ...
      data-pb-open={show_drawer(@id, @position)}
