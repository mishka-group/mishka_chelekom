defmodule DevelopmentWeb.Components.Pagination do
  @moduledoc """
  The `DevelopmentWeb.Components.Pagination` module provides a comprehensive and highly customizable
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/pagination
  ...
  attr :class, :any, default: nil, doc: "Custom class for additional styling"
