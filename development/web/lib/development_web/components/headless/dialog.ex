defmodule DevelopmentWeb.Components.Headless.Dialog do
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/headless/dialog
  """
  ...
  attr :initial_focus, :string,
    default: nil,
    doc: "Selector focused on open (default: first focusable)"
  ...
  attr :viewport_class, :any, default: nil, doc: "Extra classes for the viewport"
  ...
  attr :content_class, :any, default: nil, doc: "Extra classes for the inner content wrapper"
  attr :footer_class, :any, default: nil, doc: "Extra classes for the close/footer wrapper"
  attr :rest, :global
