defmodule DevelopmentWeb.Components.Banner do
  @moduledoc """
  DevelopmentWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
