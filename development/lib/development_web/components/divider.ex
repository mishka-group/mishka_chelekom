defmodule DevelopmentWeb.Components.Divider do
  @moduledoc """
  The `DevelopmentWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/divider
  ...
  @doc """
  `DevelopmentWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
