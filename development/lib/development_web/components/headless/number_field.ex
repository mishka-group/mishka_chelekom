  ...
  def number_field(assigns) do
    ...
    >
      <span
        ...
        class="chelekom-number_field__scrub-area"
      >
        {render_slot(@scrub_area)}
        <span
          :if={@scrub_cursor}
          data-part="scrub-area-cursor"
          class="chelekom-number_field__scrub-cursor"
        >
        </span>
      </span>
      ...
      <button
        ...
        class="chelekom-number_field__decrement"
      >
        −
      </button>
      ...
      <input
        ...
        readonly={@readonly}
        required={@required}
        class="chelekom-number_field__input"
      />
      ...
      <button
        ...
        disabled={@disabled}
        aria-readonly={@readonly && "true"}
        class="chelekom-number_field__increment"
      >
        +
      </button>
