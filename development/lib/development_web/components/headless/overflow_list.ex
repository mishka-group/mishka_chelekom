defmodule DevelopmentWeb.Components.Headless.OverflowList do
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/headless/overflow_list
  ...
  attr :on_change, :string, default: nil, doc: "Event pushed with %{hidden: n} when the count changes"
  ...
  def overflow_list(assigns) do
    ...
    >
      ...
      <span data-part="counter" data-hidden="" class={["chelekom-overflow-list__counter", @counter_class]}>
