defmodule DevelopmentWeb.Components.Badge do
  @moduledoc """
  Provides customizable and flexible badge components for use in Phoenix LiveView.

  The `DevelopmentWeb.Components.Badge` module allows you to create badge elements with various styles,
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/badge
  ...
  attr :class, :any, default: "size-4", doc: "Determines custom class"
