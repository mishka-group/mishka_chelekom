defmodule DevelopmentWeb.Components.Alert do
  @moduledoc """
  DevelopmentWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/alert
  ...
  attr :class, :any, default: nil, doc: "Custom classes"
  attr :z_index, :string, default: "z-50", doc: "custom z-index"
