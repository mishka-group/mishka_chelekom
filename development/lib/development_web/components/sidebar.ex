defmodule DevelopmentWeb.Components.Sidebar do
  @moduledoc """
  The `DevelopmentWeb.Components.Sidebar` module provides a versatile and customizable sidebar
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/sidebar
  ...
  def show_sidebar(js \\ %JS{}, id, position) when is_binary(id) do
    case hide_position(position) do
      ...
      classes ->
        JS.remove_class(js, classes, to: "##{id}") |> JS.add_class("transform-none", to: "##{id}")
    end
  end
  ...
  def hide_sidebar(js \\ %JS{}, id, position) do
    case hide_position(position) do
      ...
      classes ->
        JS.remove_class(js, "transform-none", to: "##{id}") |> JS.add_class(classes, to: "##{id}")
    end
  end
