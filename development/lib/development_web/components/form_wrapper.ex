defmodule DevelopmentWeb.Components.FormWrapper do
  @moduledoc """
  The `DevelopmentWeb.Components.FormWrapper` module provides a flexible and customizable form
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms
  ...
  defp border_class("", variant) when variant in ["outline", "bordered"], do: "border"
