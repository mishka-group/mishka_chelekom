defmodule DevelopmentWeb.Components.Clipboard do
  @moduledoc """
  The `DevelopmentWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
