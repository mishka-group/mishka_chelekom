defmodule DevelopmentWeb.Components.Tabs do
  @moduledoc """
  `DevelopmentWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import DevelopmentWeb.Components.Badge, only: [badge: 1]
  ...
  attr :scrollable, :boolean,
    default: false,
    doc:
      "When true, wraps the tab trigger list in a scroll area (horizontal scroll for horizontal tabs, vertical scroll for vertical tabs). Useful on mobile or when tabs exceed the container size. Requires the `scroll_area` component to also be generated."
    ...
    >
      ...
      <div class="ms-2 flex-1">
        <div
          ...
          class={[
            "tab-content",
            @active_index == index && "active-tab-panel",
    ...
    >
      ...
      >
        <div
          ...
          tabindex="0"
          class={[
            "tab-trigger-list flex flex-nowrap",
