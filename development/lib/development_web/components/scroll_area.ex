defmodule DevelopmentWeb.Components.ScrollArea do
  @moduledoc """
  The `DevelopmentWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/scroll-area
  ...
  attr :class, :any, default: nil, doc: "Custom CSS class for the scroll area wrapper"
