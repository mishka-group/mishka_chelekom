defmodule DevelopmentWeb.Components.Blockquote do
  @moduledoc """
  This module provides a versatile `DevelopmentWeb.Components.Blockquote` component for creating
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/blockquote
  ...
  slot :caption, required: false do
    ...
    attr :class, :any, doc: "Determines custom class for caption wrapper"
