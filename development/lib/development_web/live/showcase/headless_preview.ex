...
def show(%{component: "collapsible"} = assigns) do
  ~H"""
  <.collapsible id={@id} open class="w-72 [&_[data-part=trigger]]:w-full [&_[data-part=trigger]]:rounded-md [&_[data-part=trigger]]:border [&_[data-part=trigger]]:border-base-300 [&_[data-part=trigger]]:px-3 [&_[data-part=trigger]]:py-1.5 [&_[data-part=trigger]]:text-left [&_[data-part=trigger]]:font-medium [&_[data-part=panel]]:mt-2 [&_[data-part=panel]]:rounded-md [&_[data-part=panel]]:border [&_[data-part=panel]]:border-base-300 [&_[data-part=panel]]:bg-base-100 [&_[data-part=panel]]:p-3 [&_[data-part=panel]]:text-sm">
...
def show(%{component: "dialog"} = assigns) do
  ...
  >
    ...
    <:close>
      ...
      <button type="button" class="rounded-md bg-base-content px-3 py-1.5 text-sm text-base-100" data-close>
        Confirm
      </button>
    </:close>
  </.dialog>
...
def show(%{component: "disclosure"} = assigns) do
  ~H"""
  <.disclosure id={@id} class="w-80 rounded-md border border-base-300 [&_[data-part=trigger]]:flex [&_[data-part=trigger]]:w-full [&_[data-part=trigger]]:items-center [&_[data-part=trigger]]:justify-between [&_[data-part=trigger]]:px-3 [&_[data-part=trigger]]:py-2 [&_[data-part=trigger]]:text-left [&_[data-part=trigger]]:font-medium [&_[data-part=panel]]:border-t [&_[data-part=panel]]:border-base-300 [&_[data-part=panel]]:bg-base-100 [&_[data-part=panel]]:px-3 [&_[data-part=panel]]:py-2 [&_[data-part=panel]]:text-sm">
    <:trigger>Shipping & returns</:trigger>
    <p>
      Orders ship within two business days. Returns are accepted within 30 days
      of delivery, no questions asked. This region is toggled via
      <code>aria-expanded</code> and exposed as an ARIA region.
    </p>
  </.disclosure>
  """
end
...
def show(%{component: "fieldset"} = assigns) do
  ~H"""
  <.fieldset id={@id} class="w-80 rounded-md border border-base-300 bg-base-100 p-4 [&_[data-part=legend]]:px-1 [&_[data-part=legend]]:text-sm [&_[data-part=legend]]:font-semibold">
...
def show(%{component: "menu"} = assigns) do
  ~H"""
  <.menu id={@id} class="[&_[data-part=trigger]]:rounded-md [&_[data-part=trigger]]:border [&_[data-part=trigger]]:border-base-300 [&_[data-part=trigger]]:px-3 [&_[data-part=trigger]]:py-1.5 [&_[data-part=popup]]:mt-2 [&_[data-part=popup]]:min-w-44 [&_[data-part=popup]]:rounded-md [&_[data-part=popup]]:border [&_[data-part=popup]]:border-base-300 [&_[data-part=popup]]:bg-base-100 [&_[data-part=popup]]:p-1 [&_[data-part=popup]]:shadow-lg [&_[role=menuitem]]:block [&_[role=menuitem]]:w-full [&_[role=menuitem]]:px-3 [&_[role=menuitem]]:py-1.5 [&_[role=menuitem]]:text-left [&_[data-highlighted]]:bg-base-200 [&_[data-disabled]]:opacity-50">
...
def show(%{component: "menubar"} = assigns) do
  ~H"""
  <.menubar id={@id} class="inline-flex gap-1 rounded-md border border-base-300 bg-base-100 p-1 [&_[data-part=trigger]]:rounded [&_[data-part=trigger]]:px-3 [&_[data-part=trigger]]:py-1.5 [&_[data-part=trigger]]:text-sm [&_[data-part=trigger][aria-expanded=true]]:bg-base-200 [&_[data-part=popup]]:mt-1 [&_[data-part=popup]]:min-w-44 [&_[data-part=popup]]:rounded-md [&_[data-part=popup]]:border [&_[data-part=popup]]:border-base-300 [&_[data-part=popup]]:bg-base-100 [&_[data-part=popup]]:p-1 [&_[data-part=popup]]:shadow-lg [&_[role=menuitem]]:block [&_[role=menuitem]]:w-full [&_[role=menuitem]]:rounded [&_[role=menuitem]]:px-3 [&_[role=menuitem]]:py-1.5 [&_[role=menuitem]]:text-left [&_[role=menuitem]]:text-sm [&_[data-highlighted]]:bg-base-200">
    <:menu label="File">
...
def show(%{component: "navigation_menu"} = assigns) do
    ~H"""
    <.navigation_menu id={@id} class="flex gap-1 rounded-md border border-base-300 bg-base-100 p-1 [&_[data-part=link]]:block [&_[data-part=link]]:rounded [&_[data-part=link]]:px-3 [&_[data-part=link]]:py-1.5 [&_[data-part=link]]:text-sm [&_[data-part=link]]:hover:bg-base-200 [&_[data-part=trigger]]:rounded [&_[data-part=trigger]]:px-3 [&_[data-part=trigger]]:py-1.5 [&_[data-part=trigger]]:text-sm [&_[data-part=trigger]]:hover:bg-base-200 [&_[data-part=popup]]:mt-2 [&_[data-part=popup]]:min-w-48 [&_[data-part=popup]]:rounded-md [&_[data-part=popup]]:border [&_[data-part=popup]]:border-base-300 [&_[data-part=popup]]:bg-base-100 [&_[data-part=popup]]:p-2 [&_[data-part=popup]]:shadow-lg [&_[data-part=popup][data-closed]]:hidden [&_[data-part=popup]_a]:block [&_[data-part=popup]_a]:rounded [&_[data-part=popup]_a]:px-3 [&_[data-part=popup]_a]:py-1.5 [&_[data-part=popup]_a]:text-sm [&_[data-part=popup]_a]:hover:bg-base-200">
...
def show(%{component: "radio_group"} = assigns) do
  ~H"""
  <.radio_group id={@id} name="plan" value="pro" class="w-72 space-y-2 [&_[data-part=item]]:flex [&_[data-part=item]]:w-full [&_[data-part=item]]:cursor-pointer [&_[data-part=item]]:items-center [&_[data-part=item]]:gap-2 [&_[data-part=item]]:rounded-md [&_[data-part=item]]:border [&_[data-part=item]]:border-base-300 [&_[data-part=item]]:bg-base-100 [&_[data-part=item]]:px-3 [&_[data-part=item]]:py-2 [&_[data-part=item]]:text-left [&_[data-part=item][aria-checked=true]]:border-primary [&_[data-part=item][aria-checked=true]]:font-semibold">
...
def show(%{component: "scroll_area"} = assigns) do
  ~H"""
  <.scroll_area id={@id} orientation="vertical" class="h-48 w-72 rounded-md border border-base-300 [&_[data-part=viewport]]:h-full [&_[data-part=viewport]]:overflow-auto [&_[data-part=viewport]]:p-3 [&_[data-part=viewport]]:focus:outline-none">
...
def show(%{component: "separator"} = assigns) do
  ~H"""
  <.separator id={@id} orientation="horizontal" class="flex w-80 items-center gap-3 text-xs uppercase tracking-wide text-base-content/60 before:h-px before:flex-1 before:bg-base-300 after:h-px after:flex-1 after:bg-base-300 [&_[data-part=label]]:shrink-0">
    or continue with
  </.separator>
  """
end
...
def show(%{component: "toast"} = assigns) do
  ~H"""
  <.toast id={@id} class="flex w-80 flex-col gap-2 [&_[data-part=toast]]:relative [&_[data-part=toast]]:rounded-md [&_[data-part=toast]]:border [&_[data-part=toast]]:border-base-300 [&_[data-part=toast]]:bg-base-100 [&_[data-part=toast]]:p-3 [&_[data-part=toast]]:pr-8 [&_[data-part=toast]]:text-sm [&_[data-part=toast]]:shadow-lg [&_[data-part=dismiss]]:absolute [&_[data-part=dismiss]]:right-2 [&_[data-part=dismiss]]:top-2 [&_[data-part=dismiss]]:leading-none [&_[data-part=dismiss]]:text-base-content/60">
    <:toast>
...
def show(%{component: "toggle_group"} = assigns) do
    ~H"""
    <.toggle_group id={@id} class="inline-flex gap-1 rounded-md border border-base-300 bg-base-100 p-1 [&_[data-part=item]]:rounded [&_[data-part=item]]:px-3 [&_[data-part=item]]:py-1.5 [&_[data-part=item]]:text-sm [&_[data-part=item][data-on]]:bg-base-content [&_[data-part=item][data-on]]:text-base-100 [&_[data-part=item][data-off]]:text-base-content [&_[data-part=item][data-disabled]]:opacity-40 [&_[data-part=item][data-disabled]]:cursor-not-allowed">
