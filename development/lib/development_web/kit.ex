defmodule DevelopmentWeb.Kit do
  ...
  customize :my_checkbox do
    ...
    part :indicator,
         "[&_[data-part=indicator]]:grid [&_[data-part=indicator]]:size-5 [&_[data-part=indicator]]:place-items-center [&_[data-part=indicator]]:rounded [&_[data-part=indicator]]:border [&_[data-part=indicator]]:border-amber-200 [&_[data-part=indicator]]:bg-amber-50 dark:[&_[data-part=indicator]]:border-amber-900 dark:[&_[data-part=indicator]]:bg-amber-950/30 [&[data-checked]_[data-part=indicator]]:border-amber-500 [&[data-checked]_[data-part=indicator]]:bg-amber-500 [&[data-checked]_[data-part=indicator]]:text-amber-50 dark:[&[data-checked]_[data-part=indicator]]:border-amber-400 dark:[&[data-checked]_[data-part=indicator]]:bg-amber-400 dark:[&[data-checked]_[data-part=indicator]]:text-amber-950 [&[data-checked]_[data-part=indicator]]:after:content-['✓'] [&_[data-part=indicator]]:after:text-xs [&_[data-part=indicator]]:after:font-bold [&_[data-part=indicator]]:after:leading-none"
