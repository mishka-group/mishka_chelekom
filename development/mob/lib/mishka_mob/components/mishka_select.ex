defmodule MishkaMob.Components.MishkaSelect do
  ...
  `:anchored` node (`MishkaMob.Components.Anchored`) draws a panel in its own
  window, against the anchor's own bounds and clipped by no ancestor, and
  `MishkaMob.Components.MishkaPopover` is built on it.
  ...
  put the same options inside a bottom `MishkaMob.Components.MishkaDrawer`,
