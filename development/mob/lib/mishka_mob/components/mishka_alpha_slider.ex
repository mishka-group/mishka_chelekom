defmodule MishkaMob.Components.MishkaAlphaSlider do
  ...
  The inverse of the marker, so finger and marker cannot separate.
      ...
      iex> MishkaMob.Components.MishkaAlphaSlider.alpha_at(150, 300)
      50.0

      iex> MishkaMob.Components.MishkaAlphaSlider.alpha_at(300, 300)
      100.0

      iex> MishkaMob.Components.MishkaAlphaSlider.alpha_at(-40, 300)
      0.0
  """
