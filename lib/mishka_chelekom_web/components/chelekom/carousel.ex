defmodule MishkaChelekom.Carousel do
      ...
      <div :for={slide <- @slide} class={[
        ...
        <div class="relative w-full">
          <div class={[
            ...
            <button class=""><.icon name="hero-chevron-left" class="size-5 md:size-7 lg:size-9" /></button>
          </div>
          <.link :if={!is_nil(slide[:link])} navigate={slide[:link]}>
            <MishkaChelekom.Image.image class="max-w-full" src={slide[:image]} />
          </.link>

          <MishkaChelekom.Image.image :if={is_nil(slide[:link])} class="max-w-full" src={slide[:image]} />

          <div :if={!is_nil(slide[:title]) || !is_nil(slide[:description])} class="carousel-overlay absolute inset-0">
            <div class={[
              ...
              <div class={[
                "carousel-title",
                slide[:title_class] || "text-white"
              ]}>
                <%= slide[:title] %>
              </div>
              <p class={[
                "carousel-description",
                slide[:description_class]
              ]}>
                <%= slide[:description] %>
              </p>
            </div>
          ...
          class={[
            ...
            <button class=""><.icon name="hero-chevron-right" class="size-5 md:size-7 lg:size-9" /></button>
          </div>
        </div>
      </div>
    </div>
  ...
  defp size_class("extra_small"), do: "text-xs [&_.description-wrapper]:max-w-80 [&_.carousel-title]:md:text-xl [&_.carousel-title]:md:text-3xl"
  defp size_class("small"), do: "text-sm [&_.description-wrapper]:max-w-96 [&_.carousel-title]:md:text-xl [&_.carousel-title]:md:text-4xl"
  defp size_class("medium"), do: "text-base [&_.description-wrapper]:max-w-xl [&_.carousel-title]:md:text-2xl [&_.carousel-title]:md:text-5xl"
  defp size_class("large"), do: "text-lg [&_.description-wrapper]:max-w-2xl [&_.carousel-title]:md:text-3xl [&_.carousel-title]:md:text-6xl"
  defp size_class("extra_large"), do: "text-xl [&_.description-wrapper]:max-w-3xl [&_.carousel-title]:md:text-3xl [&_.carousel-title]:md:text-7xl"
  defp size_class(params) when is_binary(params), do: params
  defp size_class(_), do: size_class("medium")

  defp padding_size("extra_small"), do: "[&_.description-wrapper]:p-2.5 md:[&_.description-wrapper]:p-6"
  defp padding_size("small"), do: "[&_.description-wrapper]:p-3 md:[&_.description-wrapper]:p-7"
  defp padding_size("medium"), do: "[&_.description-wrapper]:p-3.5 md:[&_.description-wrapper]:p-8"
  defp padding_size("large"), do: "[&_.description-wrapper]:p-4 md:[&_.description-wrapper]:p-9"
  defp padding_size("extra_large"), do: "[&_.description-wrapper]:p-5 md:[&_.description-wrapper]:p-10"
