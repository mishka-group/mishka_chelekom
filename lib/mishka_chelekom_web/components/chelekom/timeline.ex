    ...
    <div>
        ...
        <div class="flex gap-x-3">
          ...
          <div class="grow pt-0.5 pb-8">
            <h3
              class="flex gap-x-1.5 font-semibold text-gray-800 text-sm text-sm"
            >
              <svg
        ...
        <div class="flex gap-x-3">
          ...
          <div class="grow pt-0.5 pb-8">
            ...
            >
              <span
                class="flex flex-shrink-0 justify-center items-center size-4 bg-white border -400-200 text-[10px] font-semibold uppercase text-gray-600 rounded-full"
              >
                A
              </span>
              Dummiest name
