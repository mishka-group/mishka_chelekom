const GalleryFilter = {
    mounted() {
      ...
      this.filterButtons = Array.from(this.el.querySelectorAll("[data-gallery-filter]"));
    ...
    _isItemVisible(item, category) {
      return category === this.defaultFilter || item.dataset.category.toLowerCase() === category;
    },
