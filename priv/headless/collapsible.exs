  ...
  collapsible: [
    ...
    scripts: [
      %{
        ...
        type: "file",
        file: "disclosure.js",
        imports: "import Disclosure from \"./disclosure.js\";"
      }
    ],
    headless: [
      anatomy: [
        parts: [
          item: [
            element: "div",
            data_attributes: ["data-value", "data-open", "data-disabled", "data-on-open-change"]
          ],
          trigger: [
            element: "button",
          ...
          panel: [
            ...
            note: "closed panel carries `hidden` (or `hidden=\"until-found\"`) when kept mounted"
          ]
        ]
      ],
