  ...
  navigation_menu: [
    ...
    anatomy: [
      parts: [
        ...
        popup: [element: "div", role: "menu", aria: ["aria-label"], data_attributes: ["data-open", "data-closed"]]
      ]
    ],
    aria_pattern: [pattern: "Disclosure", keyboard: ["Enter/Space: toggle panel", "Escape: close"]],
